...
interface Props {
  ...
  onBack?: () => void;
  /**
   * When provided, tapping the ConnectionPill calls this instead of
   * onSettingsPress. Ticket 3 wires this to open HowShouldIAnswerSheet.
   * TODO: Ticket 2 may re-define this prop — the last merged branch wins.
   */
  ...
  return (
    <View style={[styles.header, { paddingTop: 6 + insets.top }]}>
      ...
      <View style={styles.right}>
        <ConnectionPill onPress={onConnectionPillPress ?? onSettingsPress} />
