...
export interface NarratorPromptParts {
  ...
  reference?: string;
  /**
   * Per-call clamp for the reference field.
   * Defaults to REFERENCE_MAX_CHARS (600) when omitted.
   * Online RAG callers should pass 1500 to allow longer Wikipedia extracts.
   */
